    ...
    <div class="game-panel">
      ...
      <div class="slider-row">
        <div class="slider-item">
          ...
          <input type="range" min="50" max="300" v-model.number="snakeSpeed" />
          <span class="slider-value">{{ snakeSpeed }}</span>
        </div>
        <div class="slider-item">
          <span class="slider-label">食物速度</span>
          <input type="range" min="500" max="5000" step="100" v-model.number="foodSpeed" />
...
defineExpose({ gameCtx, CANVAS_SIZE, GRID_SIZE, CELL_SIZE })
</script>
